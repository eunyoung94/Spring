...
public class NoticeController {
	...
	@Autowired //dao에서 주입받아야하므로 autowired
	...
	public String regist(Notice notice) {//스프링에서는 vo 멤버변수와html의 파라미터명이 같으면 자동으로 터에터 vo값이 온다. 
		noticeService.insert(notice);
		return "redirect:/client/notice/list";
	}
	
	//모든 글 가져오기 
	@RequestMapping(value="/notice/list",method=RequestMethod.GET)//모든글 가져오기
	...
	//삭제요청처리
	public String delte(int notice_id) {
